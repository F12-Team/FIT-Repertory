...
Revision ID: 25da2efa989a
Revises: 8c68d9de7e7a
Create Date: 2021-04-29 00:50:49.208826
...
revision = '25da2efa989a'
down_revision = '8c68d9de7e7a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['image_id'], ['images.id'], name=op.f('fk_faculties_image_id_images')),
